...
import { orgReposData } from "../../utils/GithubAPI"
import { useState, useEffect } from "react"
import { LanguageBubble } from "../../utils/LanguageBubble";
...
export const Projects = () => {
    ...
    const repoFromGit = orgReposData(Current)
                ...
                <div className="col-sm-6 col-md-12 col-lg-6 col-xl-4 mb-3" key={repo.id}>
                    <div className="github-component d-flex flex-column flex-justify-between height-full text-left border border-gray-light bg-white rounded-1 p-3">
                        ...
                        <div className="d-flex f6">
                            <LanguageBubble lang={"repo.language"} />
                            <span className="mr-3" itemProp="programmingLanguage">
                                {repo.language}
                            </span>
                            <a href="https://github.com/github/government.github.com/stargazers" className="d-inline-block link-gray mr-4">
                            ...
                            <a href="https://github.com/github/government.github.com/network/members" className="d-inline-block link-gray mr-4">
